...
#Problem: To solve the given linear equation using GAUSSS SEIDAL METHOD

'''Algo reference: https://en.wikipedia.org/wiki/Gaussseidal'''
...
for i in range(100):
    ...
    if np.all(abs(x-xtrue)<0.01):
        break
y=abs(x-xtrue)
#showing the Gaussseidal solution
